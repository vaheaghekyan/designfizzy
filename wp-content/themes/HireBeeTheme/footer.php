	...
	<footer class="row footer">
		<div class="large-12 columns">
			...
			<!--<div id="theme-info" class="footer-info large-7 columns">.
				<div class="footer-credits">HireBee, <a href="<?php //echo esc_url( site_url() ); ?>" target="_blank"> a freelance marketplace theme</a>, developed by <a href="http://www.appthemes.com">AppThemes</a>, powered by <a href="http://www.wordpress.org" target="_blank">WordPress</a>.</div>
			</div>-->
