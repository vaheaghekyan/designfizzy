			...
			<div class="large-12 columns">
				...
				<div class="row collapse">
					<div class="large-12 column">
						...
						<input type="submit" id="submit_proposal" class="agree button" disabled onclick='return confirm("<?php echo __( 'You\'re applying to this project. Proceed?', APP_TD ); ?>")' value="<?php echo esc_attr( $bt_step_text ); ?>" />
					</div>
