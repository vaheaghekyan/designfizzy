 ...
 */
get_template_part('tgm-plugin/class-tgm-plugin-activation');

add_action( 'tgmpa_register', 'dentistry_register_required_plugins' );
/**
 ...
 */
function dentistry_register_required_plugins() {
	/*
	...
	$plugins = array(
         array(
            'name'      => 'Dentistry Code',
            'slug'      => 'dentistry-code',
            'source'    => get_template_directory_uri() .'/inc/files/dentistry-code.zip',			          
            'required'  => true,
        ),  
        array(
