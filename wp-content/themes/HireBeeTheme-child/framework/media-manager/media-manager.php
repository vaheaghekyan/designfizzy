...
/* show image url */
//		$link .= html( 'p', array( 'class' =>  'file-description' ), $file['url'] );
		echo html( 'div', $thumb . ' ' . $link );
		return;
	}
/* show psd file url*/
	if( $file['mime_type'] == 'application/x-photoshop'){
		$thumb =  '<img src="http://f.tqn.com/y/pcsupport/1/L/A/O/-/-/psd-file.png" alt=""  width="35" height="35" />';
		$link .= html( 'p', array( 'class' =>  'file-description' ), $file['url'] );
		echo html( 'div', $thumb . ' ' . $link );
		return;
	}
/* show the name of psd file and link upload*/
//	if( $file['mime_type'] == 'application/x-photoshop'){
//		$thumb =  '<img src="http://f.tqn.com/y/pcsupport/1/L/A/O/-/-/psd-file.png" alt=""  width="35" height="35" />';
////		$link .= html( 'p', array( 'class' =>  'file-description' ), $file['url'] );
//		echo html( 'div', $thumb . ' ' . '<p>'.$link.'</p>' );
//		return;
//	}
