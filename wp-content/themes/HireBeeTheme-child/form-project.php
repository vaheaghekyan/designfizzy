	...
	<fieldset>
		...
		<div class="row">
			<div class="large-12 columns">
				<label for="post_title"><?php _e( 'Title of your logo project?', APP_TD ); ?></label>
		...
		<div class="row">
			<div class="large-12 columns">
				<label for="post_content"><?php _e( 'Logo Details', APP_TD ); ?></label>
 ...
 */
 ?>
		...
		<div class="row">
			<div class="large-12 columns">
				<div class="row collapse">
					...
					<?php if($hrb_options->unchangeable_budget == 1): ?>
						<input id="budget_price" name="budget_price" tabindex="11" type="text" class="required" readonly value="<?php echo esc_attr( $hrb_options->price_project ); ?>"/>
						<?php else: ?>
						<input id="budget_price" name="budget_price" tabindex="11" type="text" class="required" placeholder="<?php echo esc_attr__( 'e.g: 40', APP_TD ); ?>" value="<?php echo esc_attr( $project->_hrb_budget_price ); ?>"/>
                    <?php endif; ?>
					</div>
				</div>
			</div>
			<div class="large-6 columns" id="currency121">
				<div class="row collapse">
				
					<div class="large-7 columns budget-currency">
						<select id="budget_currency" name="budget_currency" tabindex="12">
    ...
    <?php if ( ! hrb_charge_listings() ): ?>
        ...
        <fieldset>
            <legend><?php _e( 'Turn Around Time', APP_TD ); ?></legend>
            <div class="row">
                <div class="large-8 columns">
                    <div class="row collapse">
                        <div class="large-6 columns">
                            <span class="prefix"><?php echo __( 'Delivery Time For Logo:', APP_TD ); ?></span>
                        </div>
                        ...
                        <div class="large-3 columns">
                            <span class="postfix"><?php echo __( 'Hours', APP_TD ); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="large-8 columns">
                    <div class="row">
                        <div class="large-8 columns">
                            <label><?php echo sprintf( __( 'Your logo will be delivered within  %s hours', APP_TD ), $hrb_options->project_duration ); ?></label>
                            <label><?php echo sprintf( __( '*Note* Revision requests may surpass the %s hours time', APP_TD ), $hrb_options->project_duration ); ?></label>
                        </div>
                    </div>
            </div>
            <?php endif; ?>
	...
	<fieldset id="optional-fields">
		...
		<div class="row">
			<div class="large-12 columns">
				<?php hrb_media_manager( $project->ID, array( 'id' => '_app_media', 'title' => __( 'Show Us Some Examples', APP_TD ) ) );  ?>
			</div>
		</div>
