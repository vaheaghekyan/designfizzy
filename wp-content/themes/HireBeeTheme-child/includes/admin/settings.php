...
class HRB_Settings_Admin extends APP_Tabs_Page {
	...
	protected function init_tabs() {
        ...
        //Add Unchangeable Fixed Budget option:
         $this->tab_sections['projects']['unchangeable'] = array(
			'title' => __( 'Unchangeable Fixed Budget', APP_TD ),
			'fields' => array(
				array(
					'title' => __( 'Unchangeable Fixed Budget', APP_TD ),
				    'type' => 'checkbox',
					'name' => 'unchangeable_budget',
					'desc' => __( 'Yes', APP_TD ),
					'tip' => __( 'Unchangeable Fixed Budget is the setting where the Admin determines a fixed price of projects. Customers will no be able to choose their own price.', APP_TD ),
				),
				array(
					...
					'type' => 'text',
					'extra' => array( 'size' => 6 ),
					'tip' => __( 'The price of projects?', APP_TD ),
				),
			),
		);
		...
		$this->tab_sections['notifications']['notification'] = array(
			...
			'fields' => array(
				...
				//notification to designers
					array(
					'title' => __( 'Designer New Project Notifications(Email)', APP_TD ),
					'type' => 'checkbox',
					'name' => 'notify_new_projects_designer',
					'desc' => __( 'Yes', APP_TD ),
					'tip' => __( 'Send notification email to designers alerting them that new projects are available to accept.', APP_TD ),
				),
